...
namespace GY.Core.DB.SQL
{
    ...
    public sealed class SqlHelper
    {
        ...
        #endregion [ExecuteNonQueryTypedParams 类型化参数(DataRow)结束]  
        ...
        #endregion [ExecuteDatasetTypedParams 类型化参数(DataRow)结束] 
        ...
        #endregion [ExecuteReaderTypedParams 类型化参数(DataRow)结束] 
        ...
        #endregion [ExecuteScalarTypedParams 类型化参数(DataRow)结束] 
        ...
        #endregion [ExecuteXmlReaderTypedParams 类型化参数(DataRow)结束]
