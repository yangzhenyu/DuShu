...
function shutoropen(menucount) {
    ...
    if (m_id('menu_' + menucount).style.display == 'none') {
        m_id('menu_' + menucount).style.display = '';
        collapsed = collapsed.replace('[' + menucount + ']', '');
        m_id('menuimg_' + menucount).src = getRootPath() + '/img/LeftNav/bt_show.png';
    } else {
        m_id('menu_' + menucount).style.display = 'none';
        collapsed += '[' + menucount + ']';
        m_id('menuimg_' + menucount).src = getRootPath() + '/img/LeftNav/bt_block.png';
    }
}
