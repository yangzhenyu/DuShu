<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" CodeFile="MUser.aspx.cs" Inherits="BaseSystem_MUser" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        $(function () {
            ...
            doQuery();
            $("#add").click(function () {
                $.AddAction(600, 280, '添加用户', "AddUser.aspx", doQuery);
            });
            $("#edit").click(function () {
                $.EditAction(600, 280, '编辑用户', "EditUser.aspx", doQuery);
            });
