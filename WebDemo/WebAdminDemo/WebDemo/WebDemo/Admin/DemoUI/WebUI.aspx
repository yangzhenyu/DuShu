            ...
            <div class="controls">
                <label class="checkbox inline">
                    <div id="uniform-inlineCheckbox1" class="checker">
                        <span>
                            <input style="opacity: 0;" id="inlineCheckbox1" value="option1" type="checkbox"></span>
                    </div>
                    Option 1
                </label>
                <label class="checkbox inline">
                    <div id="uniform-inlineCheckbox2" class="checker">
                        <span>
                            <input style="opacity: 0;" id="inlineCheckbox2" value="option2" type="checkbox"></span>
                    </div>
                    Option 2
                </label>
                <label class="checkbox inline">
                    <div id="uniform-inlineCheckbox3" class="checker">
                        <span>
                            <input style="opacity: 0;" id="inlineCheckbox3" value="option3" type="checkbox"></span>
                    </div>
                    Option 3
                </label>
            </div>
